...
- button "Close"
- text: Other 1 / 10 correct
- heading "Accuracy by Topic" [level=4]
- list:
  - listitem: "Other: 1 / 10 correct (10%)"
- heading "Quiz Results" [level=2]
- paragraph: "Your score: 1 / 10"
- strong: "Average Time per Question:"
- text: 0 sec
...
- group "What is the origin of the external oblique muscle?":
  - text: What is the origin of the external oblique muscle?
  - list:
    - listitem:
      - 'radio "Option A: External surfaces of ribs 5–12" [checked] [disabled]'
      - text: A. External surfaces of ribs 5–12 ✔️
    - listitem:
      - 'radio "Option B: Pubic tubercle" [disabled]'
      - text: B. Pubic tubercle
    - listitem:
      - 'radio "Option C: Iliac crest" [disabled]'
      - text: C. Iliac crest
    - listitem:
      - 'radio "Option D: Transverse processes of lumbar vertebrae" [disabled]'
      - text: D. Transverse processes of lumbar vertebrae
- text: "Correct! Quick Tip: The external oblique arises from ribs 5 to 12. More Info: The external oblique originates from the external surfaces of ribs 5–12 and inserts into the linea alba, iliac crest, and pubic tubercle. It helps with trunk rotation, lateral flexion, and abdominal compression. Clinical Application: Massage work on this area can ease tension from repetitive twisting or poor posture. Source: Muscles: Testing and Function – Kendall Tags: external oblique, origin, ribs Keywords: abdominal muscle, torso, core"
