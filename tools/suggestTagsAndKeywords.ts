...
function processFile(filePath: any, wordCounts: any, bigramCounts: any, trigramCounts: any) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function processFolder(folder: any, wordCounts: any, bigramCounts: any, trigramCounts: any) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function getLemmas(words: any) {
  return words.map((w: any) => nlp(w).terms().out("lemma" as any));
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function getStems(words: any) {
  const stemmer = natural.PorterStemmer;
  return words.map((w: any) => stemmer.stem(w));
}
function main() {
  let wordCounts = {};
  let bigramCounts = {};
