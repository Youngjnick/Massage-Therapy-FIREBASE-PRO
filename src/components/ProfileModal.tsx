...
export default function ProfileModal({
  ...
  useEffect(() => {
    if (!open) return;
    console.debug("[ProfileModal] Opened", { open, user });
    // Focus trap
    ...
    return () => {
      ...
      console.debug("[ProfileModal] Closed");
    };
  }, [open, onClose]);
  const avatarUrl =
  ...
  return (
    <ErrorBoundary
      fallback={
        ...
        >
          Profile failed to load. Please try again later.
        </div>
      }
    >
      <div
      ...
      >
        ...
        >
          ...
          <div className="modal-body" id="profile-modal-desc">
            <div
              style={{
                display: "flex",
            ...
            <div style={{ marginTop: 18 }}>
              <label data-testid="sign-in-out-label">
                <input
                  type="checkbox"
                  checked={signedIn}
                  onChange={onSignInOut}
                  data-testid="sign-in-out-checkbox"
                />{" "}
                Sign In/Sign Out
              </label>
            </div>
            <button
              id="smartLearningBtn"
              data-testid="smart-learning-btn-profile"
            ...
            <button
              id="analyticsBtn"
              data-testid="analytics-btn-profile"
